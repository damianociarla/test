...
--
-- Host: localhost:3306
-- Generation Time: Mar 06, 2015 alle 20:33
...
--
-- Struttura della tabella `media_pdf`
--

CREATE TABLE `media_pdf` (
  `media_id` int(11) NOT NULL,
  `size` bigint(20) DEFAULT NULL,
  `total_page_number` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Indexes for table `media_pdf`
--
ALTER TABLE `media_pdf`
 ADD PRIMARY KEY (`media_id`);
